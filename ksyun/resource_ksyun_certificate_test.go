...
func TestAccKsyunCertificate_basic(t *testing.T) {
	var val map[string]interface{}
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		},
		IDRefreshName: "ksyun_certificate.foo",
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCertificateExists("ksyun_certificate.foo", &val),
					testAccCheckCertificateAttributes(&val),
				),
			},
		},
	})
...
func TestAccKsyunCertificate_update(t *testing.T) {
	var val map[string]interface{}
	resource.ParallelTest(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheck(t)
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccCertificateUpdateConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckCertificateExists("ksyun_certificate.foo", &val),
					testAccCheckCertificateAttributes(&val),
				),
...
func testAccCheckCertificateExists(n string, val *map[string]interface{}) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		certificate["CertificateId.1"] = rs.Primary.ID
		ptr, err := client.kcmconn.DescribeCertificates(&certificate)
		if err != nil {
			return err
		}
		if ptr != nil {
			l := (*ptr)["CertificateSet"].([]interface{})
			if len(l) == 0 {
				return err
			}
		}
...
func testAccCheckCertificateAttributes(val *map[string]interface{}) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		if val != nil {
			l := (*val)["CertificateSet"].([]interface{})
			if len(l) == 0 {
				return fmt.Errorf("Certificate id is empty")
			}
		}
	...
	for _, rs := range s.RootModule().Resources {
		...
		if ptr != nil {
			...
			if len(l) == 0 {
				...
				return fmt.Errorf("Certificate still exist")
			}
		}
	}
...
resource "ksyun_certificate" "foo" {
...
const testAccCertificateUpdateConfig = `
resource "ksyun_certificate" "foo" {
	certificate_name="certificate1-update"
    private_key="-----BEGIN RSA PRIVATE KEY-----\\n-----END RSA PRIVATE KEY-----"
    public_key="-----BEGIN CERTIFICATE-----\\nWYdRxC4CjnSn/uVleWJBFcR0gj6vBPTWhQ4V\n-----END CERTIFICATE-----\n\n-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----\n\n-----BEGIN CERTIFICATE-----\\n-----END CERTIFICATE-----"
}
`
