...
func TestAccKsyunSqlserverDataSource_basic(t *testing.T) {
	resource.ParallelTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccDataSqlserverConfig,
				Check: resource.ComposeTestCheckFunc(
					testAccCheckIDExists("data.ksyun_sqlservers.search-sqlserver"),
				),
			},
		},
	})
...
const testAccDataSqlserverConfig = `
